...
class _CustomBlockedScreenState extends State<CustomBlockedScreen> {
                  ...
                  children: [
                    Expanded(
                      child: StreamBuilder(
                        ...
                        builder: (context, AsyncSnapshot<List<BaseContact?>> snapshot) {
                                    ...
                                    ? ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return BlockedUserCard(
                                              ...
                                              unblockAtsign: () async {
                                                await unblockAtsign(snapshot.data?[index]?.contact ?? AtContact());
                                              });
                                        },
                                      )
                                    : GridView.builder(
  ...
  Future<void> unblockAtsign(AtContact atsign) async {
    ...
    await _contactService.blockUnblockContact(contact: atsign, blockAction: false);

...
//   @override
//   void initState() {
//     NavigationService.navKey.currentContext!.read<AuthenticationController>().getAtSignList();
//     super.initState();
//   }
...
//                         builder: (context, authenticationController, child) => Row(
//                           children: [
//                             Expanded(
//                                 child: ListView.builder(
//                               scrollDirection: Axis.horizontal,
//                               itemCount: authenticationController.atsignList.length,
//                               itemBuilder: (context, index) {
//                                 return FutureBuilder(
//                                     future: authenticationController
//                                         .getAtContact(authenticationController.atsignList[index])
//                                         .then((value) => value),
...
//                                                       .handleSwitchAtsign(authenticationController.atsignList[index]);
...
//                                       } else {
//                                         SnackBars.errorSnackBar(content: 'Error');
...
//                                   Navigator.pop(context);
//                                 });
//                                 AuthenticationService.getInstance().handleSwitchAtsign(null);
